...
<!-- Main content -->
    <section class="content">
      ...
      <div class="box box-primary">
      	<div class="box-header with-border">
      		<div class="box-title"> Data Master Medali</div>
      		<a href="{{route('medali.create')}}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Data Medali</a>
      	</div>
      	<div class="box-body">
    ...
    <script type="text/javascript">
        ...
        var oTable = $('#tableData').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ url("administrator/dataMedali/getData") }}'
            },
            columns: [
	...
	<script type="text/javascript">
    	var url = "{{url('administrator/medali')}}/";
