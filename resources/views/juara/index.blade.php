...
<!-- Main content -->
    <section class="content">
      ...
      <div class="box box-primary">
      	<div class="box-header with-border">
      		<div class="box-title"> Data Master Juara</div>
      		<a href="{{route('juara.create')}}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Data Juara</a>
      	</div>
      	<div class="box-body">
    ...
    <script type="text/javascript">
        ...
        var oTable = $('#tableData').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ url("administrator/dataJuara/getData") }}'
            },
            columns: [
	...
	<script type="text/javascript">
    	var url = "{{url('administrator/juara')}}/";
